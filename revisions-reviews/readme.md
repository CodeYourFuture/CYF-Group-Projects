# Changes Requested on Reviews App

You work in a small development team that runs an online website where programming languages are reviewed. Following user testing, your team leader has requested that a few changes be made to the website.

![Screenshot of requested changes](requested-revisions.png)

## First Steps

1. Ask your project leader to set up a group repository based on the [sample repository](https://github.com/CodeYourFuture/group-project-revisions-reviews).
